...
<body>
		...
		<div class="nav">
			<ol class="breadcrumb">
				<li><a class="text-success">当前位置&nbsp;<i
						class="fa fa-hand-o-right">&nbsp;</i>&nbsp;添加借书
				</a></li>
			</ol>
		</div>
	</div>
	<div class="container">
		<form id="form1" role="form" method="post"
			action="${base }/permission/lend/realadd">
			<div class="container" style="width: 600px">
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="form-group">
							<label for="no">用户编号</label> <input name="no" value="${no }"
								class="form-control" type="text" placeholder="请输入用户编号" />
						</div>
						<div class="form-group">
							<label for="isbn">isbn</label> <input name="isbn"
								class="form-control" value="${isbn }" type="text" placeholder="请输入isbn" />
						</div>
						<div class="form-group">
