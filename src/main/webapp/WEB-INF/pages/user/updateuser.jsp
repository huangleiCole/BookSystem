		...
		<div class="nav">
			<ol class="breadcrumb">
				<li><a class="text-success">当前位置&nbsp;<i
						class="fa fa-hand-o-right">&nbsp;</i>&nbsp;修改用户</a></li>
			</ol>
		</div>
	</div>
	<div class="container">
		<form id="form1" role="form" method="post"
			action="${base }/permission/user/update">
			<input type="hidden" value="${updateuser.id }" name="uid">
					...
					<div class="panel-body">
						<div class="form-group">
							<label for="no">用户编号</label> <input name="no"
								class="form-control" value="${updateuser.no }" type="text"
								disabled="disabled" />

						</div>
						<div class="form-group">
							<label for="realname">真实姓名</label> <input name="realname"
								class="form-control" value="${updateuser.realname }" type="text" placeholder="请输入修改后的姓名" />
						</div>
						<div class="form-group">
							<label for="phone">联系电话</label> <input name="phone"
								class="form-control" type="text" value="${updateuser.phone }" placeholder="请输入修改后的联系电话" />
						</div>
